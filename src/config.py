...
# Location bias for contact-hunt fallback
DEFAULT_LOCATION = os.getenv("DEFAULT_LOCATION", "Ely")

# Crawling proxy (optional)
SCRAPERAPI_KEY = os.getenv("SCRAPERAPI_KEY")

# Crawl behaviour
TIMEOUT = int(os.getenv("TIMEOUT", "30"))
USER_AGENT = os.getenv("USER_AGENT",
    "Mozilla/5.0 (compatible; ChucklContactFinder/1.2; +https://github.com/your-org)")
...
# Hosts to avoid picking as “official”
BAD_HOSTS = [
